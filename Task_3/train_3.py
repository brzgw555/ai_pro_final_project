...
model = Model(
    mt.Conv(3,32),mt.Relu(),mt.Conv(32,32),mt.Relu(),mt.Conv(32,32),mt.Relu(),mt.Pool(),
    mt.Conv(32,64),mt.Relu(),mt.Conv(64,64),mt.Relu(),mt.Conv(64,64),mt.Relu(),mt.Pool(),
    mt.Conv(64,100),mt.Relu(),mt.Conv(100,100),mt.Relu(),mt.Conv(100,100),mt.Relu(),mt.Pool(),
    mt.Conv(100,256),mt.Relu(),mt.Pool(),
...
scheduler = StepLR(optim,lr,20,0.9)
